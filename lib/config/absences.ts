...
// These functions hide approval/denial information from students for privacy

export function getStudentAbsenceStatusColor(absence: Absence): string {
  // For students, only show general status without revealing approval/denial details
  switch (absence.status) {
    case 'igazolt':
      return "bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border-emerald-200 dark:bg-emerald-950/30 dark:hover:bg-emerald-950/50 dark:text-emerald-400 dark:border-emerald-800"
    case 'igazolatlan':
      return "bg-slate-50 hover:bg-slate-100 text-slate-600 border-slate-200 dark:bg-slate-900/30 dark:hover:bg-slate-900/50 dark:text-slate-400 dark:border-slate-700"
    case 'nincs_dontes':
    default:
      return "bg-blue-50 hover:bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-950/30 dark:hover:bg-blue-950/50 dark:text-blue-400 dark:border-blue-800"
  }
}

export function getStudentAbsenceStatusText(absence: Absence): string {
  // For students, show simplified status without revealing decision details
  switch (absence.status) {
    case 'igazolt':
      return "Feldolgozott"
    case 'igazolatlan':
