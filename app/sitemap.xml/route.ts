 ...
 */
export function generateSitemapIndex(sitemaps: Array<{ url: string; lastMod: string }>) {
...
/**
 * Utility function to generate sitemap for specific content type
 */
export function generateContentTypeSitemap(
  contentType: string,
  items: Array<{
    id: string;
    updatedAt?: string;
